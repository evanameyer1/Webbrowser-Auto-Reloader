...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var tabIdHeader = document.createElement('h1');
    tabIdHeader.textContent = "TabID: " + tabId;
    document.body.appendChild(tabIdHeader);

    var tabListHeader = document.createElement('h1');
    tabListHeader.textContent = "TabList: " + output;
    document.body.appendChild(tabListHeader);
